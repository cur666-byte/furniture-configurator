    ...
    toolRectShape.addEventListener('click', () => switchTool('rectangle'));
     ...
     if (clearBtn) {
         clearBtn.addEventListener('click', () => {
             ...
             // ТОЧЕЧНАЯ ПРАВКА ПАМЯТИ: сохраняем текущий инструмент и обновляем подсветку
             if (currentTool === 'pencil') {
     ...
     // ВОТ ОНИ! Добавляем потерянные три строчки инициализации размеров окна и закрываем функцию модуля
